...
const submitHandler = async (e) => {
  e.preventDefault();
  try {
    const res = await axios.post("http://localhost:5000/api/v3/user/register", input, {
    ...
    const message = error.response?.data?.msg || "Account already exists with the same email";
    toast.error(message);
  }
}
  ...
  return (
    ...
    <div className="flex items-center justify-center w-screen h-screen">   
      ...
      <div className="w-full flex justify-center mb-2"> <Logo /> </div>  
